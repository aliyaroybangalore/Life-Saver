...
public class LifeSaverContacts extends Activity {
	...
	public void ShowLifeSaverContact() {
	...
	private class listrow extends ArrayAdapter<String> {
		...
		public listrow(Context context, ArrayList<String> names) {
			super(context, R.layout.lifesaver_contacts, names);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			final View v = inflater.inflate(R.layout.lifesaver_contacts, parent,
					false);
			Typeface font = Typeface.createFromAsset(getAssets(), "rcl.ttf");
