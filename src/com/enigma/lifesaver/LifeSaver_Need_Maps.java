...
public class LifeSaver_Need_Maps extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lifesaver_need_maps);
	...
	private void GetLocation() {
		...
		// Log.v("lat", lat);
		// Log.v("lon", lon);
		GPSTracker gps = new GPSTracker(LifeSaver_Need_Maps.this);
		do {
	...
	private class connectAsyncTask extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			progressDialog = new ProgressDialog(LifeSaver_Need_Maps.this);
