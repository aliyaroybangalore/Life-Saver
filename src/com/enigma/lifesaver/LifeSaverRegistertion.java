...
public class LifeSaverRegistertion extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lifesaver_registertion);
		tv1 = (TextView)findViewById(R.id.TVLifeSaverCommunity);
		...
		Register.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (CheckNetwork.isInternetAvailable(LifeSaverRegistertion.this)) {
	...
	private void startnextactivity() {
		if (status == 1) {
			...
			editor.commit();
			startActivity(new Intent(LifeSaverRegistertion.this, Verification.class));
			LifeSaverRegistertion.this.finish();
			Log.v("Login", "Username and Password");
	...
	private class SetConnection extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			dialog = new ProgressDialog(LifeSaverRegistertion.this);
